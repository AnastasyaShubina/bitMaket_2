    ...
    document.querySelector('.mainBlockAbout--container__img--animation'),
    {
      framePath:
        window.innerWidth < 768
          ? './images/animationMobile/1_screen/img00000.jpg'
          : window.innerWidth < 1024
          ? './images/animationPad/1_screen/img00000.jpg'
          : './images/animationDesctop/1_screen/img00000.jpg',
      frameCount: 82,
      scrollArea: 2900,
      identifier: ''
    }
...
export const animation2 = () => {
  const canvasScrollClip2 = new CanvasScrollClip(
    document.querySelector('.secondBlockAbout--container__schedule--animation'),
    {
      framePath:
        window.innerWidth < 768
          ? './images/animationMobile/2_screen/img00000.jpg'
          : window.innerWidth < 1024
          ? './images/animationPad/2_screen/img00000.jpg'
          : './images/animationDesctop/2_screen/img00000.jpg',
      frameCount: 43,
  ...
  const stickyElement = document.querySelector(
    '.secondBlockAbout--container__text'
  )
